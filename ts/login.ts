...
const emailInput = document.querySelector<HTMLInputElement>("#exampleInputEmail1");
const passwordInput = document.querySelector<HTMLInputElement>("#exampleInputPassword1");
const fileInput = document.querySelector<HTMLInputElement>("#formFile");
const status = document.querySelector<HTMLParagraphElement>("#loginStatus");
const showPasswordButton = document.querySelector<HTMLButtonElement>("#showPassword");
const usernameError = document.querySelector<HTMLDivElement>("#usernameError");
...
const passwordGroup = document.querySelector<HTMLDivElement>("#passwordGroup");
...
form?.addEventListener("submit", async (event) => {
  ...
  if (!status || !usernameInput || !emailInput || !passwordInput) return;
